<template>
    ...
    <div class="container content year dashboard">
        ...
        <div v-if="showYear">
            ...
            <div class="empty-subject-photo" v-if="showSubjectEmptyPhoto">
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            this.routeImgStudies = this.route_base_images_vue +"/content/clip-education_v2.png";
            this.routeImgSubjects = this.route_base_images_vue +"/content/clip-uploading_v2.png";
        },
        data(){
            return{
                chosed_year_vue:'',
